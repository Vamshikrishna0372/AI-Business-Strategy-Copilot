  ...
  return (
    <header className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-4">
      <div className="min-w-0 animate-rise">
        {eyebrow ? (
          <p className="max-w-full truncate text-xs font-semibold uppercase tracking-[0.18em] text-primary">{eyebrow}</p>
        ) : null}
        <h1 className="break-words text-xl font-semibold sm:text-2xl lg:text-3xl">{title}</h1>
